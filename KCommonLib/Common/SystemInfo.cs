...
namespace KCommonLib.Common
{
    ...
    public class SystemInfo
    {
        ...
        /// 获取分区信息 
        ///  
        public List<object> GetLogicalDrives()
        {
        ...
        ///  
        /// 盘符 
        public List<object> GetLogicalDrives(char DriverID)
        {
            List<object> drives = new List<object>();
        ...
        {
            List<object> pInfo = new List<object>();
        ...
        ///  
        /// 进程名称 
        public List<object> GetProcessInfo(string ProcessName)
        {
            List<object> pInfo = new List<object>();
        ...
        ///  
        /// 应用程序标题范型 
        public static List<object> FindAllApps(int Handle)
        {
