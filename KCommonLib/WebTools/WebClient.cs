...
namespace KCommonLib.WebTools
{
    ...
    ///<param name="e"></param>
    public delegate void WebClientUploadEvent(object sender, KCommonLib.WebTools.UploadEventArgs e);
    ...
    ///<param name="sender"></param>
    ///<param name="e"></param>
    public delegate void WebClientDownloadEvent(object sender, KCommonLib.WebTools.DownloadEventArgs e);
