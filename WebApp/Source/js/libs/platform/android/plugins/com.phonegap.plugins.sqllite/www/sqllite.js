cordova.define("com.phonegap.plugins.sqllite.SqlLite", function (require, exports, module) {
    ...
    SQLitePlugin.prototype.open = function (success, error) {
        if (!(this.dbname in this.openDBs)) {
           ...
           exec(success, error, "SQLitePlugin", "open", [this.openargs]);
        }
    };
    ...
    SQLitePlugin.prototype.close = function (success, error) {
        if (this.dbname in this.openDBs) {
           ...
           exec(null, null, "SQLitePlugin", "close", [
              {
                  path: this.dbname
              }
            ]);
    ...
    SQLitePluginTransaction.prototype.run = function () {
       ...
       exec(mycb, null, "SQLitePlugin", mycommand, [
          {
              dbargs: {
    ...
    SQLiteFactory = {
        ...
        deleteDb: function (databaseName, success, error) {
            return exec(success, error, "SQLitePlugin", "delete", [
              {
                  path: databaseName
              }
            ]);
